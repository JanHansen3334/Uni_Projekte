...
%maybeTurn([[[x,x,x,o,o],[x,o,x,o," "],[x,x,o,x," "],[o,o,o," "," "]],x],[2,3,4],Ret,[]).
%searchTurn([[[[[x,x,x,o,o],[x,o,x,o,x],[x,x,o,x," "],[o,o,o," "," "]],o],2],[[[[x,x,x,o,o],[x,o,x,o," "],[x,x,o,x,x],[o,o,o," "," "]],o],3],[[[[x,x,x,o,o],[x,o,x,o," "],[x,x,o,x," "],[o,o,o,x," "]],o],4]],Ret,[]).
%computerTurn([[[x,x,x,o,o],[x,o,x,o," "],[x,x,o,x," "],[o,o,o," "," "]],x],[3,2],Ret,[]).
%betterTurn([[[[[x,x,x,o,o],[x,o,x,o,x],[x,x,o,x," "],[o,o,o," "," "]],o],2],[[[[x,x,x,o,o],[x,o,x,o," "],[x,x,o,x,x],[o,o,o," "," "]],o],3]],Ret).
...
betterTurn(NextStateList,BetterReturn) :- 
		...
		%nextStepComputer(NextStateListHuman,ComputerTurnTwo,[]),
...
% Schreibt die Computer Schritte in eine Liste.
%nextStepComputer([],ComputerTurnTwo,List):- ComputerTurnTwo = List.
%nextStepComputer(NextStateListHuman,ComputerTurnTwo,List):-
%			NextStateListHuman = [Head|Tail],
%			nextStateComputer(Head,ComputerTurnTwoA,[]),
%			List1 = [ComputerTurnTwoA|List],
%			nextStepComputer(Tail,ComputerTurnTwo,List1), !.
